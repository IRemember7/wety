...
Component({
  ...
  data: {
    ...
    cnvacation: [
      { 'name': '国务院假期国庆节、中秋节', 'data': '10月1日至8日放假调休，共8天。9月27日（星期日）、10月10日（星期六）上班' },
      { 'name': '天院假期', 'data': '10月1日至4日放假' }]
  },
  created: function () {
    util.extDate();
  },
      ...
      for (let i = 0; i < 6; ++i) {
        ...
        for (let k = 0; k < 7; ++k) {
          ...
          if (k === 5 || k === 6) {
            ...
            // 创新，新增补课
            if (unitDate == '2020-09-27' || unitDate == '2020-10-10') {
              // unitObj.type = "补课"; unitObj.detach = "cdetach";
            }
            ...
            // 创新，新增假期
            if (unitDate == '2020-10-01' || unitDate == '2020-10-02' || unitDate == '2020-10-03' || unitDate == '2020-10-04' ) {
              unitObj.type = "假期";
              unitObj.color += "weekend ";
              unitObj.detach = "vacation";
            }
          }
